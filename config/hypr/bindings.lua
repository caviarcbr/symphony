...
hl.bind("SUPER + W", function()
	browser.launch()
end, { description = "Launch Browser" })

-- Private Browser Window
hl.bind("SUPER + SHIFT + W", function()
	browser.launch({ "--private" })
end, { description = "Launch Browser" })

-- WebApps
hl.bind("SUPER + G", function()
	browser.webapp("https://github.com")
end, { description = "Github" })

hl.bind("SUPER + Y", function()
	browser.webapp("https://youtube.com")
end, { description = "Youtube" })

hl.bind("SUPER + R", function()
	browser.webapp("https://reddit.com")
end, { description = "Reddit" })

hl.bind("SUPER + T", function()
	browser.webapp("https://twitch.tv")
end, { description = "Twitch" })

hl.bind("SUPER + SHIFT + T", function()
	browser.webapp("https://kick.com")
end, { description = "Kick" })
...
hl.bind("SUPER + SLASH", function()
	rofi.keyhints()
end, { description = "Show All Keybindings" })

hl.bind("ALT + period", function()
	rofi.emoji()
end, { description = "emoji" })

hl.bind("ALT + comma", function()
	rofi.clipboard()
end, { description = "clipboard" })
...
hl.bind("SUPER + ALT + S", function()
	fileshare.file()
end, { description = "Localsend File" })

hl.bind("SUPER + CTRL + S", function()
	fileshare.folder()
end, { description = "Localsend Folder" })

hl.bind("SUPER + SHIFT + S", function()
	fileshare.clipboard()
end, { description = "Localsend Clipboard" })
...
hl.bind("CTRL + ALT + SPACE", function()
	rofi.random_wallpaper()
end, { description = "Select awww wall" })
...
hl.bind("SUPER + ALT + P", function()
	screengrab.save()
end, { description = "Screenshot with editing" })

hl.bind("SUPER + SHIFT + PRINT", function()
	screengrab.clip()
end, { description = "Screenshot to clipboard" })

-- Screen Recordings
hl.bind("SUPER + CTRL + R", function()
	screenrecord.desk()
end, { description = "Record Screen" })

hl.bind("SUPER + SHIFT + R", function()
	screenrecord.deskmic()
end, { description = "Record + Mic" })

hl.bind("SUPER + ALT + R", function()
	screenrecord.cam()
end, { description = "Record + Mic + Webcam" })
