...
hl.bind("SUPER + W", hl.dsp.exec_cmd(browser), { description = "Browser" }, { description = "Browser" })
...
hl.bind("SUPER + G", hl.dsp.exec_cmd(webapp .. " 'https://github.com'"), { description = "Github" })
...
hl.bind("SUPER + SHIFT + SPACE", hl.dsp.exec_cmd(ScrDir .. "/toggle-waybar"), { description = "Toggle waybar" })
hl.bind("SUPER + CTRL + I", hl.dsp.exec_cmd(ScrDir .. "/toggle-idle"), { description = "Toggle Idle/Lock" })

-- LocalSend
hl.bind("SUPER + ALT + S", hl.dsp.exec_cmd("kitty --title share -e " .. ScrDir .. "/fileshare file"), {description = "Localsend File"})
hl.bind("SUPER + CTRL + S", hl.dsp.exec_cmd("kitty --title share -e " .. ScrDir .. "/fileshare folder"), {description = "Localsend Folder"})
hl.bind("SUPER + SHIFT + S", hl.dsp.exec_cmd("kitty --title share -e " .. ScrDir .. "/fileshare clipboard"), {description = "Localsend Clipboard"})
...
hl.bind("SUPER + SLASH", hl.dsp.exec_cmd(RofiDir .. "/keyhints"), { description = "Show All Keybindings" })
